...
class Department(models.Model):
    ...
    department_head = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, related_name='head_of_department', blank=True, null=True)
...
class Designation(models.Model):
    department =  models.ForeignKey(Department, on_delete=models.SET_NULL, related_name='designations', null=True, blank=True)
...
class Employee(models.Model):
    ...
    promotion_designation = models.ForeignKey(Designation, on_delete=models.SET_NULL, related_name='promotion', null=True, blank=True)
...
class Promotion(models.Model):
    employee = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True, related_name='promoted_employee')
    ...
    new_salary = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    past_position = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True, related_name='past')
    new_position = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True, related_name='new')
    employment_type = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True, blank=True)
...
class Training(models.Model):
    training_course = models.ForeignKey(Course, on_delete=models.CASCADE, related_name='courses', null=True)
    trainer = models.ForeignKey(Course, on_delete=models.SET_NULL, related_name='trainer', null=True)
    initiated_date = models.DateTimeField(auto_now_add=True, null=True)
...
class DevelopmentPlan(models.Model):
    ...
    employee = models.ForeignKey(Employee, on_delete=models.SET_NULL, related_name='IDP_employee', null=True)
    goal = models.ForeignKey(Task, on_delete=models.SET_NULL, blank=True, null=True)
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, blank=True, null=True)
    coach = models.ForeignKey(Employee, on_delete=models.SET_NULL, blank=True, null=True, related_name='coach')
    initiated_date = models.DateTimeField(auto_now_add=True, null=True)
    STATUS_CHOICES = (
        ('NI', 'Not Initiated'),
        ('I', 'Initiated'),
...
class Matrix(models.Model):
    ...
    category = models.CharField(max_length=2, choices=POTENTIAL_CHOICES, null=True)
...
class Appraisal(models.Model):
    ...
    appraisal_cycle = models.CharField(max_length=100, null=True) #appraisal_name
    ...
    due_date = models.DateTimeField(null=True) #for report ከጠቀመ እንጂ no other use
    STATUS_CHOICES = (
        ('P', 'Pending'),
        ('IP', 'In Progress'),
        ('C', 'Completed'),
    ...
    appraisal_Status = models.CharField(max_length=50, choices=STATUS_CHOICES, null=True)
    final_rating = models.DecimalField(max_digits=10, decimal_places=2, null=True) #potential assessment
...
class News(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, null=True)
    publisher = models.ForeignKey(Employee, on_delete=models.SET_NULL, related_name='Author', null=True)

    # Employees who can view this news
    employees = models.ManyToManyField(Employee, related_name='news', blank=True)

    # Managers who can view this news
    managers = models.ManyToManyField(Employee, related_name='manager_news', blank=True)
...
class Notification(models.Model):
    ...
    recipient = models.ForeignKey(CustomUser, on_delete=models.CASCADE, null=True, related_name='recipient_notification')
